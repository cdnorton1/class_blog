...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { blog_author: @blog_post.blog_author, blog_entry: @blog_post.blog_entry, blog_title: @blog_post.blog_title }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { blog_author: @blog_post.blog_author, blog_entry: @blog_post.blog_entry, blog_title: @blog_post.blog_title }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
